{
  ...
  '#':: d.pkg(name='clickHouseInstallation', url='', help='"define a set of Kubernetes resources (StatefulSet, PVC, Service, ConfigMap) which describe behavior one or more clusters"'),
  ...
  '#new':: d.fn(help='new returns an instance of ClickHouseInstallation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    configuration: {
      ...
      clusters: {
        ...
        layout: {
          ...
          replicas: {
            ...
            shards: {
              ...
              templates: {
                ...
                '#withServiceTemplate':: d.fn(help='"optional, template name from chi.spec.templates.serviceTemplates. used for customization of the `Service` resource, created by `clickhouse-operator` to cover all clusters in whole `chi` resource"', args=[d.arg(name='serviceTemplate', type=d.T.string)]),
                withServiceTemplate(serviceTemplate): { templates+: { serviceTemplate: serviceTemplate } },
                '#withServiceTemplates':: d.fn(help='"optional, template names from chi.spec.templates.serviceTemplates. used for customization of the `Service` resources, created by `clickhouse-operator` to cover all clusters in whole `chi` resource"', args=[d.arg(name='serviceTemplates', type=d.T.array)]),
                withServiceTemplates(serviceTemplates): { templates+: { serviceTemplates: if std.isArray(v=serviceTemplates) then serviceTemplates else [serviceTemplates] } },
                '#withServiceTemplatesMixin':: d.fn(help='"optional, template names from chi.spec.templates.serviceTemplates. used for customization of the `Service` resources, created by `clickhouse-operator` to cover all clusters in whole `chi` resource"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceTemplates', type=d.T.array)]),
                withServiceTemplatesMixin(serviceTemplates): { templates+: { serviceTemplates+: if std.isArray(v=serviceTemplates) then serviceTemplates else [serviceTemplates] } },
                ...
                '#withVolumeClaimTemplate':: d.fn(help='"optional, alias for dataVolumeClaimTemplate, template name from chi.spec.templates.volumeClaimTemplates, allows customization each `PVC` which will mount for clickhouse data directory in each `Pod` during render and reconcile every StatefulSet.spec resource described in `chi.spec.configuration.clusters`"', args=[d.arg(name='volumeClaimTemplate', type=d.T.string)]),
          ...
          '#withShards':: d.fn(help='"optional, allows override top-level `chi.spec.configuration`, cluster-level\\n`chi.spec.configuration.clusters` settings for each shard separately,\\nuse it only if you fully understand what you do\\"\\n"', args=[d.arg(name='shards', type=d.T.array)]),
          withShards(shards): { layout+: { shards: if std.isArray(v=shards) then shards else [shards] } },
          '#withShardsCount':: d.fn(help='"how much shards for current ClickHouse cluster will run in Kubernetes,\\neach shard contains shared-nothing part of data and contains set of replicas,\\ncluster contains 1 shard by default\\"\\n"', args=[d.arg(name='shardsCount', type=d.T.integer)]),
          withShardsCount(shardsCount): { layout+: { shardsCount: shardsCount } },
          '#withShardsMixin':: d.fn(help='"optional, allows override top-level `chi.spec.configuration`, cluster-level\\n`chi.spec.configuration.clusters` settings for each shard separately,\\nuse it only if you fully understand what you do\\"\\n"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='shards', type=d.T.array)]),
        ...
        reconcile: {
          ...
          runtime: {
            ...
            withReconcileShardsMaxConcurrencyPercent(reconcileShardsMaxConcurrencyPercent): { reconcile+: { runtime+: { reconcileShardsMaxConcurrencyPercent: reconcileShardsMaxConcurrencyPercent } } },
            ...
            withReconcileShardsThreadsNumber(reconcileShardsThreadsNumber): { reconcile+: { runtime+: { reconcileShardsThreadsNumber: reconcileShardsThreadsNumber } } },
          },
        },
        ...
        withInsecure(insecure): { insecure: insecure },
        '#withName':: d.fn(help='"cluster name, used to identify set of servers and wide used during generate names of related Kubernetes resources"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withPdbMaxUnavailable':: d.fn(help='"Pod eviction is allowed if at most \\"pdbMaxUnavailable\\" pods are unavailable after the eviction,\\ni.e. even in absence of the evicted pod. For example, one can prevent all voluntary evictions\\nby specifying 0. This is a mutually exclusive setting with \\"minAvailable\\".\\n"', args=[d.arg(name='pdbMaxUnavailable', type=d.T.integer)]),
        withPdbMaxUnavailable(pdbMaxUnavailable): { pdbMaxUnavailable: pdbMaxUnavailable },
        ...
        zookeeper: {
          ...
          nodes: {
            '#withAvailabilityZone':: d.fn(help='"availability zone for Zookeeper node"', args=[d.arg(name='availabilityZone', type=d.T.string)]),
      ...
      '#withClusters':: d.fn(help='"describes clusters layout and allows change settings on cluster-level, shard-level and replica-level\\nevery cluster is a set of StatefulSet, one StatefulSet contains only one Pod with `clickhouse-server`\\nall Pods will rendered in <remote_server> part of ClickHouse configs, mounted from ConfigMap as `/etc/clickhouse-server/config.d/chop-generated-remote_servers.xml`\\nClusters will use for Distributed table engine, more details: https://clickhouse.tech/docs/en/engines/table-engines/special/distributed/\\nIf `cluster` contains zookeeper settings (could be inherited from top `chi` level), when you can create *ReplicatedMergeTree tables\\n"', args=[d.arg(name='clusters', type=d.T.array)]),
      withClusters(clusters): { spec+: { configuration+: { clusters: if std.isArray(v=clusters) then clusters else [clusters] } } },
      '#withClustersMixin':: d.fn(help='"describes clusters layout and allows change settings on cluster-level, shard-level and replica-level\\nevery cluster is a set of StatefulSet, one StatefulSet contains only one Pod with `clickhouse-server`\\nall Pods will rendered in <remote_server> part of ClickHouse configs, mounted from ConfigMap as `/etc/clickhouse-server/config.d/chop-generated-remote_servers.xml`\\nClusters will use for Distributed table engine, more details: https://clickhouse.tech/docs/en/engines/table-engines/special/distributed/\\nIf `cluster` contains zookeeper settings (could be inherited from top `chi` level), when you can create *ReplicatedMergeTree tables\\n"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='clusters', type=d.T.array)]),
    ...
    defaults: {
      ...
      templates: {
        ...
        '#withServiceTemplates':: d.fn(help='"optional, template names from chi.spec.templates.serviceTemplates. used for customization of the `Service` resources, created by `clickhouse-operator` to cover all clusters in whole `chi` resource"', args=[d.arg(name='serviceTemplates', type=d.T.array)]),
        withServiceTemplates(serviceTemplates): { spec+: { defaults+: { templates+: { serviceTemplates: if std.isArray(v=serviceTemplates) then serviceTemplates else [serviceTemplates] } } } },
        '#withServiceTemplatesMixin':: d.fn(help='"optional, template names from chi.spec.templates.serviceTemplates. used for customization of the `Service` resources, created by `clickhouse-operator` to cover all clusters in whole `chi` resource"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceTemplates', type=d.T.array)]),
        withServiceTemplatesMixin(serviceTemplates): { spec+: { defaults+: { templates+: { serviceTemplates+: if std.isArray(v=serviceTemplates) then serviceTemplates else [serviceTemplates] } } } },
        '#withShardServiceTemplate':: d.fn(help='"optional, template name from chi.spec.templates.serviceTemplates, allows customization for each `Service` resource which will created by `clickhouse-operator` which cover each shard inside clickhouse cluster described in `chi.spec.configuration.clusters`"', args=[d.arg(name='shardServiceTemplate', type=d.T.string)]),
    ...
    reconciling: {
      '#cleanup':: d.obj(help='"Optional, defines behavior for cleanup Kubernetes resources during reconcile cycle"'),
      cleanup: {
        '#reconcileFailedObjects':: d.obj(help='"Describes what clickhouse-operator should do with Kubernetes resources which are failed during reconcile.\\nDefault behavior is `Retain`\\"\\n"'),
        reconcileFailedObjects: {
          '#withConfigMap':: d.fn(help='"Behavior policy for failed ConfigMap, `Retain` by default"', args=[d.arg(name='configMap', type=d.T.string)]),
          withConfigMap(configMap): { spec+: { reconciling+: { cleanup+: { reconcileFailedObjects+: { configMap: configMap } } } } },
          '#withPvc':: d.fn(help='"Behavior policy for failed PVC, `Retain` by default"', args=[d.arg(name='pvc', type=d.T.string)]),
          withPvc(pvc): { spec+: { reconciling+: { cleanup+: { reconcileFailedObjects+: { pvc: pvc } } } } },
          '#withService':: d.fn(help='"Behavior policy for failed Service, `Retain` by default"', args=[d.arg(name='service', type=d.T.string)]),
          withService(service): { spec+: { reconciling+: { cleanup+: { reconcileFailedObjects+: { service: service } } } } },
          '#withStatefulSet':: d.fn(help='"Behavior policy for failed StatefulSet, `Retain` by default"', args=[d.arg(name='statefulSet', type=d.T.string)]),
          withStatefulSet(statefulSet): { spec+: { reconciling+: { cleanup+: { reconcileFailedObjects+: { statefulSet: statefulSet } } } } },
        },
        '#unknownObjects':: d.obj(help='"Describes what clickhouse-operator should do with found Kubernetes resources which should be managed by clickhouse-operator,\\nbut do not have `ownerReference` to any currently managed `ClickHouseInstallation` resource.\\nDefault behavior is `Delete`\\"\\n"'),
        unknownObjects: {
      ...
      runtime: {
        '#withReconcileShardsMaxConcurrencyPercent':: d.fn(help='"The maximum percentage of cluster shards that may be reconciled in parallel, 50 percent by default."', args=[d.arg(name='reconcileShardsMaxConcurrencyPercent', type=d.T.integer)]),
        withReconcileShardsMaxConcurrencyPercent(reconcileShardsMaxConcurrencyPercent): { spec+: { reconciling+: { runtime+: { reconcileShardsMaxConcurrencyPercent: reconcileShardsMaxConcurrencyPercent } } } },
        '#withReconcileShardsThreadsNumber':: d.fn(help='"How many goroutines will be used to reconcile shards of a cluster in parallel, 1 by default"', args=[d.arg(name='reconcileShardsThreadsNumber', type=d.T.integer)]),
        withReconcileShardsThreadsNumber(reconcileShardsThreadsNumber): { spec+: { reconciling+: { runtime+: { reconcileShardsThreadsNumber: reconcileShardsThreadsNumber } } } },
      },
    ...
    templates: {
      ...
      podTemplates: {
        ...
        podDistribution: {
          ...
          '#withTopologyKey':: d.fn(help='"use for inter-pod affinity look to `pod.spec.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution.podAffinityTerm.topologyKey`,\\nmore info: https://kubernetes.io/docs/concepts/scheduling-eviction/assign-pod-node/#inter-pod-affinity-and-anti-affinity\\"\\n"', args=[d.arg(name='topologyKey', type=d.T.string)]),
        ...
        '#withGenerateName':: d.fn(help='"allows define format for generated `Pod` name, look to https://github.com/Altinity/clickhouse-operator/blob/master/docs/custom_resource_explained.md#spectemplatesservicetemplates for details about available template variables"', args=[d.arg(name='generateName', type=d.T.string)]),
      ...
      withServiceTemplatesMixin(serviceTemplates): { spec+: { templates+: { serviceTemplates+: if std.isArray(v=serviceTemplates) then serviceTemplates else [serviceTemplates] } } },
      '#withVolumeClaimTemplates':: d.fn(help='"allows define template for rendering `PVC` kubernetes resource, which would use inside `Pod` for mount clickhouse `data`, clickhouse `logs` or something else\\n"', args=[d.arg(name='volumeClaimTemplates', type=d.T.array)]),
    ...
    '#useTemplates':: d.obj(help='"list of `ClickHouseInstallationTemplate` (chit) resource names which will merge with current `CHI`\\nmanifest during render Kubernetes resources to create related ClickHouse clusters\\"\\n"'),
    useTemplates: {
    ...
    '#withSuspend':: d.fn(help='"Suspend reconciliation of resources managed by a ClickHouse Installation.\\nWorks as the following:\\n - When `suspend` is `true` operator stops reconciling all resources.\\n - When `suspend` is `false` or not set, operator reconciles all resources.\\n"', args=[d.arg(name='suspend', type=d.T.string)]),
    ...
    '#withUseTemplates':: d.fn(help='"list of `ClickHouseInstallationTemplate` (chit) resource names which will merge with current `CHI`\\nmanifest during render Kubernetes resources to create related ClickHouse clusters\\"\\n"', args=[d.arg(name='useTemplates', type=d.T.array)]),
    withUseTemplates(useTemplates): { spec+: { useTemplates: if std.isArray(v=useTemplates) then useTemplates else [useTemplates] } },
    '#withUseTemplatesMixin':: d.fn(help='"list of `ClickHouseInstallationTemplate` (chit) resource names which will merge with current `CHI`\\nmanifest during render Kubernetes resources to create related ClickHouse clusters\\"\\n"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='useTemplates', type=d.T.array)]),
