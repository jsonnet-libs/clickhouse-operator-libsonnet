{
  ...
  '#':: d.pkg(name='clickHouseInstallationTemplate', url='', help='"define a set of Kubernetes resources (StatefulSet, PVC, Service, ConfigMap) which describe behavior one or more clusters"'),
