---
permalink: /0.25/clickhouse/v1/clickHouseOperatorConfiguration/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.clickhouse`](#obj-specclickhouse)
    ...
    * [`obj spec.clickhouse.addons`](#obj-specclickhouseaddons)
      * [`fn withRules(rules)`](#fn-specclickhouseaddonswithrules)
      * [`fn withRulesMixin(rules)`](#fn-specclickhouseaddonswithrulesmixin)
      * [`obj spec.clickhouse.addons.rules`](#obj-specclickhouseaddonsrules)
        * [`fn withVersion(version)`](#fn-specclickhouseaddonsruleswithversion)
        * [`obj spec.clickhouse.addons.rules.spec`](#obj-specclickhouseaddonsrulesspec)
          * [`obj spec.clickhouse.addons.rules.spec.configuration`](#obj-specclickhouseaddonsrulesspecconfiguration)
            * [`fn withFiles(files)`](#fn-specclickhouseaddonsrulesspecconfigurationwithfiles)
            * [`fn withFilesMixin(files)`](#fn-specclickhouseaddonsrulesspecconfigurationwithfilesmixin)
            * [`fn withProfiles(profiles)`](#fn-specclickhouseaddonsrulesspecconfigurationwithprofiles)
            * [`fn withProfilesMixin(profiles)`](#fn-specclickhouseaddonsrulesspecconfigurationwithprofilesmixin)
            * [`fn withQuotas(quotas)`](#fn-specclickhouseaddonsrulesspecconfigurationwithquotas)
            * [`fn withQuotasMixin(quotas)`](#fn-specclickhouseaddonsrulesspecconfigurationwithquotasmixin)
            * [`fn withSettings(settings)`](#fn-specclickhouseaddonsrulesspecconfigurationwithsettings)
            * [`fn withSettingsMixin(settings)`](#fn-specclickhouseaddonsrulesspecconfigurationwithsettingsmixin)
            * [`fn withUsers(users)`](#fn-specclickhouseaddonsrulesspecconfigurationwithusers)
            * [`fn withUsersMixin(users)`](#fn-specclickhouseaddonsrulesspecconfigurationwithusersmixin)
  ...
  * [`obj spec.metrics`](#obj-specmetrics)
    * [`obj spec.metrics.labels`](#obj-specmetricslabels)
      * [`fn withExclude(exclude)`](#fn-specmetricslabelswithexclude)
      * [`fn withExcludeMixin(exclude)`](#fn-specmetricslabelswithexcludemixin)
  ...
  * [`obj spec.reconcile`](#obj-specreconcile)
    * [`obj spec.reconcile.host`](#obj-specreconcilehost)
      * [`obj spec.reconcile.host.wait`](#obj-specreconcilehostwait)
        ...
        * [`obj spec.reconcile.host.wait.replicas`](#obj-specreconcilehostwaitreplicas)
          * [`fn withAll(all)`](#fn-specreconcilehostwaitreplicaswithall)
          * [`fn withDelay(delay)`](#fn-specreconcilehostwaitreplicaswithdelay)
          * [`fn withNew(new)`](#fn-specreconcilehostwaitreplicaswithnew)
...
## obj spec.clickhouse.addons

"Configuration addons specifies additional settings"

### fn spec.clickhouse.addons.withRules
...
### fn spec.clickhouse.addons.withRulesMixin
...
## obj spec.clickhouse.addons.rules

"Array of set of rules per specified ClickHouse versions"

### fn spec.clickhouse.addons.rules.withVersion
...
## obj spec.clickhouse.addons.rules.spec

"spec"

## obj spec.clickhouse.addons.rules.spec.configuration
...
### fn spec.clickhouse.addons.rules.spec.configuration.withFiles
...
### fn spec.clickhouse.addons.rules.spec.configuration.withFilesMixin
...
### fn spec.clickhouse.addons.rules.spec.configuration.withProfiles
...
### fn spec.clickhouse.addons.rules.spec.configuration.withProfilesMixin
...
### fn spec.clickhouse.addons.rules.spec.configuration.withQuotas
...
### fn spec.clickhouse.addons.rules.spec.configuration.withQuotasMixin
...
### fn spec.clickhouse.addons.rules.spec.configuration.withSettings
...
### fn spec.clickhouse.addons.rules.spec.configuration.withSettingsMixin
...
### fn spec.clickhouse.addons.rules.spec.configuration.withUsers
...
### fn spec.clickhouse.addons.rules.spec.configuration.withUsersMixin
...
## obj spec.metrics.labels

"defines metric labels options"

### fn spec.metrics.labels.withExclude
...
### fn spec.metrics.labels.withExcludeMixin
...
### fn spec.reconcile.host.wait.replicas.withDelay
...
### fn spec.reconcile.host.wait.replicas.withNew
